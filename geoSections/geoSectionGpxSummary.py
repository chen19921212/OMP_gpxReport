...
class geoSectionGpxSummaryCommon(dict):
    ...
    def __str__(self):
        ...
        string += "{0}{1:<20s}{2}{3:.2f} km\r".format(self.indentation, "Length 2D:", "", self["Length 2D"])
        string += "{0}{1:<20s}{2}{3:.2f} km\r".format(self.indentation, "Length 3D:", "", self["Length 3D"])

        string += "{0}{1:<20s}{2}{3}\r".format(self.indentation, "Moving time:", "", self["Moving time"])
        string += "{0}{1:<20s}{2}{3}\r".format(self.indentation, "Stopped time:", "", self["Stopped time"])
        string += "{0}{1:<20s}{2}{3:.2f} m/s = {4:.2f} km/h\r".format(self.indentation, "Max speed:", "",
                                                                      self["Max speed"],
                                                                      self["Max speed"] * 60. ** 2 / 1000. if self[
                                                                          "Max speed"] else 0)

        string += "{0}{1:<20s}{2}{3:.0f} m\r".format(self.indentation, "Total uphill:", "", self["Total uphill"])
        string += "{0}{1:<20s}{2}{3:.0f} m\r".format(self.indentation, "Total downhill:", "", self["Total downhill"])

        string += "{0}{1:<20s}{2}{3}\r".format(self.indentation, "Started:", "", self["Started"])
        string += "{0}{1:<20s}{2}{3}\r\r".format(self.indentation, "Ended:", "", self["Ended"])
